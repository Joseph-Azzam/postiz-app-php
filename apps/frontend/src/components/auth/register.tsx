...
function getHelpfulReasonForRegistrationFailure(httpCode: number) {
  switch (httpCode) {
    ...
    case 404:
      return 'Your browser got a 404 when trying to contact the API. Check that your backend URL (NEXT_PUBLIC_BACKEND_URL or NEXT_PUBLIC_LARAVEL_BACKEND_URL when using Laravel) is set correctly and the backend is running.';
  }
